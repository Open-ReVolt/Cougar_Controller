...
version 1.11 - added motor_speed_calc_amps - attempt to avoid overspeed tripping pedal is "pumped"
...
{
	#ifdef PWM8K
	strcpy_P(uart_str, PSTR("Cougar OS controller firmware v1.11 (8KPWM)\r\n"));
	#else
	strcpy_P(uart_str, PSTR("Cougar OS controller firmware v1.11\r\n"));
	#endif
	uart_putstr();
}
